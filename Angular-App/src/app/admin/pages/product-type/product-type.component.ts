...
import { AttachmentTypeDto } from 'app/shared/api-clients/files.client';
import { ConfirmationService, MessageService } from 'primeng/api';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';
import { ProductType, ShippingAppClients } from 'app/shared/api-clients/shipping-app.client';
...
export class ProductTypeComponent implements OnInit {
  ...
  reloadData() {
    this.shippingClient.apiShippingappProducttypeGetallproducttype(0).subscribe((data) => (this.productType = data));
  }
  ...
  deleteProductType(productType: ProductType) {
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.shippingClient
          .apiShippingappProducttypeDeleteproducttype(productType.id)
  ...
  handleAddProductType() {
    ...
    this.shippingClient
      .apiShippingappProducttypeProducttypePost(this.form.value)
  ...
  handleUpdateProductType() {
    this.shippingClient
      .apiShippingappProducttypeUpdateproducttype(this.form.value.id, this.form.value)
      .pipe(takeUntil(this.destroyed$))
      .subscribe(
        (result) => {
          if (result > 0) {
