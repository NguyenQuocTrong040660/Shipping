    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<UserResult[]>>(<any>_observableThrow(response_));
        })
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<CreateUserResult[]>>(<any>_observableThrow(response_));
        })
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<RoleModel[]>>(<any>_observableThrow(response_));
        })
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<IdentityResult>>(<any>_observableThrow(response_));
        })
      );
  }
