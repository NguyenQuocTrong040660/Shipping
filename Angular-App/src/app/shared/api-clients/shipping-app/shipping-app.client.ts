...
export class ProductClients {
    ...
    verifyImportProduct(products: ProductModel[]): Observable<ImportResult[]> {
        let url_ = this.baseUrl + "/api/shippingapp/product/verifyimportproduct";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVerifyImportProduct(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVerifyImportProduct(<any>response_);
                } catch (e) {
    ...
    protected processVerifyImportProduct(response: HttpResponseBase): Observable<ImportResult[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
            let result200: any = null;
            result200 = _responseText === "" ? null : <ImportResult[]>JSON.parse(_responseText, this.jsonParseReviver);
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class ReceivedMarkClients {
    ...
    printReceivedMarkWithPrintingId(receivedMarkPrintingId: number, request: PrintReceivedMarkRequest): Observable<ReceivedMarkPrintingModel> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPrintReceivedMarkWithPrintingId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPrintReceivedMarkWithPrintingId(<any>response_);
                } catch (e) {
                    return <Observable<ReceivedMarkPrintingModel>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPrintReceivedMarkWithPrintingId(response: HttpResponseBase): Observable<ReceivedMarkPrintingModel> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getReceivedMarkPrintingsByWorkOrder(workOrderId: number | undefined): Observable<ReceivedMarkPrintingModel[]> {
        let url_ = this.baseUrl + "/api/shippingapp/receivedmark/receivedmarkprintings/workorder?";
        if (workOrderId === null)
            throw new Error("The parameter 'workOrderId' cannot be null.");
        else if (workOrderId !== undefined)
            url_ += "WorkOrderId=" + encodeURIComponent("" + workOrderId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetReceivedMarkPrintingsByWorkOrder(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetReceivedMarkPrintingsByWorkOrder(<any>response_);
                } catch (e) {
                    return <Observable<ReceivedMarkPrintingModel[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetReceivedMarkPrintingsByWorkOrder(response: HttpResponseBase): Observable<ReceivedMarkPrintingModel[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    printReceivedMarkByWorkOrder(query: PrintReceivedMarkByWorkOrderCommand): Observable<ReceivedMarkPrintingModel> {
        let url_ = this.baseUrl + "/api/shippingapp/receivedmark/receivedmarkprintings/workorder/printing";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPrintReceivedMarkByWorkOrder(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPrintReceivedMarkByWorkOrder(<any>response_);
                } catch (e) {
                    return <Observable<ReceivedMarkPrintingModel>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPrintReceivedMarkByWorkOrder(response: HttpResponseBase): Observable<ReceivedMarkPrintingModel> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ShippingPlanClients {
    ...
    verifyImportShippingPlan(shippingPlans: ShippingPlanImportModel[]): Observable<ImportResult[]> {
        let url_ = this.baseUrl + "/api/shippingapp/shippingplan/verifyimportshippingplan";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(shippingPlans);
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVerifyImportShippingPlan(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVerifyImportShippingPlan(<any>response_);
                } catch (e) {
                    return <Observable<ImportResult[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVerifyImportShippingPlan(response: HttpResponseBase): Observable<ImportResult[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class WorkOrderClients {
    ...
    verifyImportWorkOrder(workOrderImports: WorkOrderImportModel[]): Observable<ImportResult[]> {
        let url_ = this.baseUrl + "/api/shippingapp/workorder/verifyimportworkorder";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVerifyImportWorkOrder(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVerifyImportWorkOrder(<any>response_);
                } catch (e) {
                    return <Observable<ImportResult[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVerifyImportWorkOrder(response: HttpResponseBase): Observable<ImportResult[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export interface PrintReceivedMarkByWorkOrderCommand {
    workOrderId?: number;
...
export interface ShippingPlanImportModel {
    ...
    salelineNumber?: string | undefined;
    productNumber?: string | undefined;
    quantityOrder?: string | undefined;
